        ...
        public static void main(String[] args) throws IOException
            {
                ...
                /*System.out.println(((JSONArray)api.get(OrbisAPI.Endpoint.OmsCorporateActions, "{range}", "WEEK")).toString(2));
                System.out.println(((JSONArray)api.get(OrbisAPI.Endpoint.OmsCorporateActionTypes)).toString(2));*/
                System.out.println(((JSONArray)api.get(OrbisAPI.Endpoint.OmsCorporateActionSearch, new CorporateActionsSearch().symbol("MSFT").type("Dividend"))).toString(2));
