 ...
 * 5/15/2019 9:30 PM
 */
public class C2CCachieringFeed implements OrbisApiClient
    {
        ...
        public static void main(String[] args) throws Exception
            {
                ...
                C2CCachieringFeed feed = new C2CCachieringFeed();
        ...
        public String getEndpoint()
            {
                return "/transfers/feed";
            }

        @Override
        public void onOpen(ServerHandshake handshakedata)
            {
                System.out.println(new Date() + ">> (*) Connection established");
            }
        ...
        public void onClose(int code, String reason, boolean remote)
            {
                System.out.printf(new Date() + ">> (-) Closed. Code: %s; Reason: %s; Remote: %s\n", code, reason, remote);
            }
